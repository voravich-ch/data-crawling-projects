...
# xpaths
mt_cr_score_xpath = '//table[@class="score_wrapper"]//td[@class="num_wrapper"]/span'
mt_cr_n_score_xpath = '//table[@class="score_wrapper"]//span[@class="score_description"]/span[@class="based_on"]'
mt_cr_n_pos_xpath = '//td[@class="right"]//*[@class="chart_wrapper"]'
mt_cr_n_neg_xpath = '//td[@class="right"]//*[@class="chart_wrapper"]'
mt_cr_n_mixed_xpath = '//td[@class="right"]//*[@class="chart_wrapper"]'


class mtCrScoreSpider(scrapy.Spider):
    name = 'mt_cr_score'
    allowed_domains = ['web']
    start_urls = urls
    ...
    def parse(self, response):    
        ...
        # primary fields
        l.add_xpath('mt_cr_score', mt_cr_score_xpath)
        l.add_xpath('mt_cr_n_score', mt_cr_n_score_xpath)
        l.add_xpath('mt_cr_n_pos', mt_cr_n_pos_xpath)
        l.add_xpath('mt_cr_n_neg', mt_cr_n_neg_xpath)
        l.add_xpath('mt_cr_n_mixed', mt_cr_n_mixed_xpath)
